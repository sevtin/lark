...
func (ctrl *ChatCtrl) RemoveGroupChatMember(ctx *gin.Context) {
	var (
		params = new(dto_chat.RemoveGroupChatMemberReq)
		resp   *xhttp.Resp
		uid    int64
		err    error
	)
	...
	resp = ctrl.chatService.RemoveGroupChatMember(params, uid)
	if resp.Code > 0 {
