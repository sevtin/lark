...
CREATE TABLE `order_items` (
  ...
  `order_sn` char(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT 'order_sn',
  `spu_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT 'spu_id',
  `spu_name` varchar(200) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT 'spu_name',
  `cat_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '商品分类id',
  `sku_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '商品sku编号',
  `sku_name` varchar(200) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '商品sku名字',
  ...
  `sku_attrs` varchar(500) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '商品销售属性组合（JSON）',
