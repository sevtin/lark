...
type Order struct {
	...
	Status      int    `gorm:"column:status;default:0;NOT NULL" json:"status"`           // 订单状态 0-PENDING 1-PAID 2-CANCELLED 3-REFUNDED
	...
	TagId       string `gorm:"column:tag_id;NOT NULL" json:"tag_id"`                     // Tag ID
}
...
type OrderItem struct {
	...
	OrderSn           string `gorm:"column:order_sn;NOT NULL" json:"order_sn"`                               // order sn
